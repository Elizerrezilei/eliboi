...
<body> 
<h1>Hello Student : <?= $_SESSION['user_data'] ['name'] ?></h1>
<div class="container"> 	
<div class="row"> 	
<div class="col-lg-12"> 		
...
<div class="col-lg-12"> 			
<table class="table"> 				
<tr><th colspan="3">Sample Academic Year Semester</th></tr> 				
<tr> 					
<th>Subject</th> 					
<th>Marks</th> 					
...
<div class="col-lg-12"> 			
<h2>No results found, Please wait for the release of Grades.</h2> 		
</div> 	<?php }	?>
 </div> 
</div> 
</body> 
