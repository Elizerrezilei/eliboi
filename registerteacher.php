<?php include 'connect.php'; ?>
 <!DOCTYPE html> <html> <head> 
	...
	<body> 	
	<form action="register_for_teacher.php" method="post"> 
	<div class="container"> 		
	<div class="row"> 			
	<a href="index.php" class="btn btn-primary" style="margin:10px;">Back to Login</a> 		
	</div> 		
	<div class="row"> 		
	<?php if(isset($_REQUEST['error'])){ ?> 	
		...
		<span class="alert alert-success" style="display: block;"><?php echo $_REQUEST['success']; ?></span> 	
			...
			<div class="row"> 		
				<h2 style="margin:15px;" class="text-center">Teachers Registration Form</h2> 		
